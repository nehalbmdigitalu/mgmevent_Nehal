...
<!-- Mirrored from jthemes.net/themes/html/harmony-event/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 09:55:29 GMT -->
...
<head>
    ...
    <title>MGM - Frequently Ask Qusetion</title>
    <link rel="shortcut icon" href="assets/images/favicon.png">

    <!-- fraimwork - css include -->
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css"><?php include 'include/header.php';?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="breadcrumb-title text-center mb-50">
                                <span class="sub-title">mgm events</span>
                                <h2 class="big-title">mgm <strong>FAQ</strong></h2>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseone" class="collapse" aria-labelledby="headingone"
                                    ...
                                    <div class="card-body">
                                        ...
                                        everything you need to host your best event yet. lorem ipsum diamet.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="faq-accordion2" class="faq-accordion">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingfive">
                                    <button class="btn" data-toggle="collapse" data-target="#collapsfive"
                                        aria-expanded="true" aria-controls="collapsfive">
                                        <span>05.</span> How to join MGM Event Management?
                                    </button>
                                </div>

                                <div id="collapsfive" class="collapse show" aria-labelledby="headingfive"
                                    data-parent="#faq-accordion2">
                                    <div class="card-body">
                                        <h3>answer</h3>
                                        Bring people together, or turn your passion into a business. MGM gives you
                                        everything you need to host your best event yet. lorem ipsum diamet.
                        ...
                        <div id="faq-accordion3" class="faq-accordion">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingten">
                                    <button class="btn" data-toggle="collapse" data-target="#collapseten"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingeleven">
                                    <button class="btn collapsed" data-toggle="collapse" data-target="#collapseeleven"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingtwelve">
                                    <button class="btn collapsed" data-toggle="collapse" data-target="#collapsetwelve"
                        ...
                        <div id="faq-accordion4" class="faq-accordion">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingthirteen">
                                    <button class="btn" data-toggle="collapse" data-target="#collapsthirteen"
                                        aria-expanded="true" aria-controls="collapsthirteen">
                                        <span>05.</span> How to join MGM Event Management?
                                    </button>
                                </div>

                                <div id="collapsthirteen" class="collapse show" aria-labelledby="headingthirteen"
                                    data-parent="#faq-accordion4">
                                    <div class="card-body">
                                        <h3>answer</h3>
                                        Bring people together, or turn your passion into a business. MGM gives you
                                        everything you need to host your best event yet. lorem ipsum diamet.
                            ...
                            <div class="card">
                                <div class="card-header" id="headingfourteen">
                                    <button class="btn collapsed" data-toggle="collapse" data-target="#collapsefourteen"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingfifteen">
                                    <button class="btn collapsed" data-toggle="collapse" data-target="#collapsefifteen"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingsixteen">
                                    <button class="btn collapsed" data-toggle="collapse" data-target="#collapsesixteen"
