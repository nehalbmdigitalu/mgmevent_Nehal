...
<!-- Mirrored from jthemes.net/themes/html/harmony-event/event-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 09:55:29 GMT -->
<head>
		...
		<title>MGM - Event List</title>
		<link rel="shortcut icon" href="assets/images/favicon.png"><?php include 'include/header.php';?>		<!-- breadcrumb-section - start
			================================================== -->
							...
							<div class="row justify-content-center">
								<div class="col-lg-6 col-md-12 col-sm-12">
									...
									<div class="breadcrumb-title text-center mb-50">
										...
										<h2 class="big-title">mgm <strong>event</strong></h2>
									</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-12 col-sm-12">
							<div class="section-title">
								<small class="sub-title">Find best event on MGM</small>
											...
											<div class="overlay-black clearfix">
												...
												<div class="leftside-content">
													...
													<div class="copyright-text">
														<p class="m-0">©2018 <a href="#!" class="yellow-color">MGM.com</a> all right reserved, made with <i class="fas fa-heart"></i> by jThemes Studio </p>
													</div>
												</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<div class="copyright-text">
								<p class="m-0">©2018 <a href="#!" class="site-link">MGM.com</a> all right reserved, made with <i class="fas fa-heart"></i> by <a href="#!" class="author-link"><strong>jThemes Studio</strong></a></p>
							</div>
						</div>
						<!-- copyright-text - end -->
...
<!-- Mirrored from jthemes.net/themes/html/harmony-event/event-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 09:55:30 GMT -->
</html>